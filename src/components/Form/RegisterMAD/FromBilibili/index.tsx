            ...
            <div className={clsx("flex gap-x-2")}>
              <div
                className={clsx(
                  ...
                  [
                    "cursor-pointer rounded border border-slate-700 bg-slate-950 text-xs font-bold text-slate-400 hover:bg-slate-800 aria-checked:cursor-default aria-checked:border-slate-600 aria-checked:bg-slate-700 aria-checked:text-slate-400 aria-disabled:cursor-default aria-disabled:border-slate-800 aria-disabled:bg-slate-900 aria-disabled:text-slate-700",
                  ]
                )}
